function slider({container, slide, nextArrow, previousArrow, totalCounet, currentCounter, wrapper, field}) {
    let offset = 0;
    let slideIndex = 1;
    ...
    const slides = document.querySelectorAll(slide),
        ...
        total = document.querySelector(totalCounet),
